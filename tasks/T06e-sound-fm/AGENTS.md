...
- Без picture FM changes, если они не требуются контракту.
- без AES3.
- без UI.
...
- `src/watermark/**`
- `src/audio/**`
- `tests/integration/watermark/sound/**`
- `docs/IMPLEMENT.md`
- `docs/STATUS.md`
...
```bash
./scripts/build.sh
./scripts/test.sh -R 'sound_fm|audio_watermark'
```
