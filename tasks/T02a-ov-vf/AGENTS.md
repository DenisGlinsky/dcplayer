...
- Без supplemental semantics.
- без playback timeline.
- без UI.
...
- `tests/unit/dcp/ov_vf_resolver/**`
- `tests/integration/dcp/ov_vf/**`
- `tests/fixtures/dcp/**`
- `specs/objects/CompositionGraph.md`
- `docs/STATUS.md`
- `docs/IMPLEMENT.md`
...
- OV/VF
- диагностика missing/conflicting assets
- integration tests
...
```bash
./scripts/build.sh
./scripts/test.sh -R 'ov|vf|resolver'
```
