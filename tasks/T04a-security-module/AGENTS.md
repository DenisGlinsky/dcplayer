# AGENTS.md — T04a Security Module
...
- Без реальной аппаратной криптографии.
...
- `src/security_api/**`
- `spb1/simulator/**`
- `tests/integration/security/simulator/**`
- `specs/objects/SecurityModuleContract.md`
- `docs/IMPLEMENT.md`
- `docs/STATUS.md`
...
```bash
./scripts/build.sh
./scripts/test.sh -R 'simulator|security_module'
```
